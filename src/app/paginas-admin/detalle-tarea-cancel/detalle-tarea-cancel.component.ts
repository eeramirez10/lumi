...
@Component({
  selector: 'app-detalle-tarea-cancel',
  templateUrl: './detalle-tarea-cancel.component.html',
  styleUrls: ['./detalle-tarea-cancel.component.css']
})
export class DetalleTareaCancelComponent implements OnInit {
