...
@Component({
  selector: "app-prospectos-c",
  templateUrl: "./prospectos-c.component.html",
  styleUrls: ["./prospectos-c.component.css"],
})
export class ProspectosCComponent implements OnInit, AfterViewInit {
