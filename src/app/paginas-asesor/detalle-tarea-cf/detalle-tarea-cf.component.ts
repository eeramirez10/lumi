...
@Component({
  selector: 'app-detalle-tarea-cf',
  templateUrl: './detalle-tarea-cf.component.html',
  styleUrls: ['./detalle-tarea-cf.component.css']
})
export class DetalleTareaCFComponent implements OnInit {
